...
Il numero di canali utilizzati influenza direttamente capacit\`a e qualit\`a:

\begin{table}[H]
\centering
\begin{tabular}{|c|c|c|}
\hline
\textbf{Canali} & \textbf{Capacit\`a} & \textbf{Qualit\`a} \\ \hline
1 (R) & Bassa & Alta \\ \hline
2 (R,G) & Media & Media \\ \hline
3 (R,G,B) & Alta & Bassa \\ \hline
\end{tabular}
