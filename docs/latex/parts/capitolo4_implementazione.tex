...
In questa sezione presentiamo test dell'algoritmo LSB per l'occultamento di immagini,
variando LSB e MSB per analizzare il trade-off tra qualità visiva e fedeltà dell'immagine
recuperata.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/lsb_4-msb_4.png}
        \caption{Immagine stego con LSB=4, MSB=4}
        \label{fig:lsb_4_4_stego}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/recovered_lsb_4-msb_4.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/lsb_1-msb_1.png}
        \caption{Immagine stego con LSB=1, MSB=1}
        \label{fig:lsb_1_1_stego}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/recovered_lsb_1-msb_1.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/capacita-lsb_6-msb_2.png}
        \caption{Immagine stego con LSB=6, MSB=2}
        \label{fig:lsb_6_2_stego}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/recovered_lsb_6-msb_2.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/lsb_7-msb_8.png}
        \caption{Immagine stego con LSB=7, MSB=8}
        \label{fig:lsb_7_8_stego}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\textwidth]{assets/lsb/recovered_lsb_7-msb_8.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{assets/lsb/lsb_auto-msb_auto.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/lsb/n2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/lsb/n4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/lsb/n6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/lsb/n8.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/lsb/n8-div1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/dwt/qualita-alpha_005-banda_ch-1ch-ssim_7726-psnr_2662.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/dwt/capacita-alpha_015-3bande-3ch-ssim8910-psnr_3524.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/dwt/qualita-alpha_030-3bande-ech-ssim_9203-psnr_3447.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/host.jpg}
