...
def get_image(
    ...
    if method == SteganographyMethod.DWT:
        ...
        return LsbImage.get_image(img, output_path, lsb, msb, div, width, height, backup_file)
...
def hide_bin_file(
    ...
    if method == SteganographyMethod.DWT:
        ...
        return LsbBinary.hide_binary_file(img, file_path, compression_mode, n, div, backup_file)
...
def get_bin_file(
    ...
    if method == SteganographyMethod.DWT:
        ...
        return PvdBinary.get_binary_file(img, output_path, size=size, backup_file=backup_file)
    else:  # Default: LSB
        LsbBinary.get_binary_file(img, output_path, compression_mode, n, div, size, backup_file)
